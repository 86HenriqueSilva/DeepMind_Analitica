...
# Ordenar os números com base na quantidade de ocorrências
...
number_average = {number: (count, count / total_samples * 100) for number, count in sorted_numbers}

# Exibir os resultados
print("Média e quantidade de ocorrências de GRUPOS (em ordem crescente):")
