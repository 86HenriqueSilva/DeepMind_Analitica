...
# Ordenar as dezenas com base na quantidade de ocorrências
sorted_dezenas = sorted(dezena_counts.items(), key=lambda x: x[1])

# Calcular a média das contagens de cada dezena
total_samples = sum(dezena_counts.values())
dezena_average = {dezena: (count, count / total_samples * 100) for dezena, count in sorted_dezenas}

# Exibir os resultados
print("Média e quantidade de ocorrências de cada MC 1º ao 5º (em ordem crescente):")
